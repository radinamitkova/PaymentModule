...
insert into clients(id, name, email, phone_number) values('client5','Stefan K','radidna_m@email.com','0885123821');
insert into clients(id, name, email, phone_number) values('client6','Test M','payment.module.drim@abv.bg','0885123329');
...
INSERT INTO DUTY_ACCOUNT(client_id, currency, duty, start_date) VALUES ('client1','BGN', 1050, TO_DATE('2022-12-29', 'YYYY-MM-DD'));
...
INSERT INTO DUTY_ACCOUNT(client_id, currency, duty, start_date) VALUES ('client6','USD', 2500, TO_DATE('2021-07-15', 'YYYY-MM-DD'));

INSERT INTO Duty_History(duty_account_id, payment, time) VALUES (4, 400.23, SYSDATE);
INSERT INTO Duty_History(duty_account_id, payment, time) VALUES (4, 200.7688, TO_DATE('2020-12-30 10:25:55', 'YYYY-MM-DD hh24:mi:ss'));
INSERT INTO Duty_History(duty_account_id, payment, time) VALUES (4, 125, TO_DATE('2022-01-01 16:30:00', 'YYYY-MM-DD hh24:mi:ss'));
